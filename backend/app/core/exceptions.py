...
class AuthError(MarquesIAError):
    """Falha de autenticação/autorização no painel administrativo."""


class RateLimitExceededError(MarquesIAError):
    """Cliente ultrapassou o limite de requisições permitido."""
