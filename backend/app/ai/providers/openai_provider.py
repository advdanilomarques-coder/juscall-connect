"""Provedor de IA: GPT (OpenAI).

Serve como reserva (ou principal, conforme configuração): se o modelo
anterior ficar indisponível, o gerenciador alterna automaticamente para
este provedor, sem o cliente perceber a troca.

O SDK `openai` é importado de forma lazy.
"""
        ...
        *,
        ...
        try:
            ...
            raise AIProviderError(
                "SDK 'openai' não instalado. Rode: pip install openai"
            ) from exc
