...
echo "  1) Edite o arquivo .env e coloque pelo menos UMA chave de IA"
echo "     (GEMINI_API_KEY é gratuita: https://aistudio.google.com/apikey)."
echo "  2) source .venv/bin/activate"
echo "  3) uvicorn app.main:app --reload"
echo ""
echo "  Documentação interativa da API: http://localhost:8000/docs"
